...
bool SyntaxValidator::checkFormat3or4Operand(OpInfo info)
{
    ...
    {
        bool hasExpression = ValidatorUtilities::isExpression(splittedOperands[0],this->GENERAL_EXPRESSION_ALLOWED);
    ...
    else if(splittedOperands.size()==1)
    {
        ...
        bool hasExpression = ValidatorUtilities::isExpression(nonPrefixedOperand,this->GENERAL_EXPRESSION_ALLOWED);
        this->sourceLine->setContainsExpression(hasExpression);
...
bool SyntaxValidator::checkDirectiveOperand()
{
    ...
    else if(directive == "WORD")
    {
        ...
        {
            bool hasExpression = ValidatorUtilities::isExpression(str,this->GENERAL_EXPRESSION_ALLOWED);
            this->sourceLine->setContainsExpression(hasExpression);
            if(!ValidatorUtilities::isSymbol(str,LABEL_MAXLENGTH) && !sourceLine->getContainsExpression()
